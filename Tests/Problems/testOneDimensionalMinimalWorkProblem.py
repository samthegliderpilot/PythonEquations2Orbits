...
class testOneDWorkSymbolicProblem(unittest.TestCase) :
    def testBoilerplate(self) :
        ...
        self.assertEqual(0, problem.FinalBoundaryConditions[0].subs(problem.StateVariables[0].subs(problem.TimeSymbol, problem.TimeFinalSymbol), 1), msg="bc1")
        self.assertEqual(1, problem.FinalBoundaryConditions[1].subs(problem.StateVariables[1].subs(problem.TimeSymbol, problem.TimeFinalSymbol), 1), msg="bc2")
