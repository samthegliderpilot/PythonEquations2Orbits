...
class testOneDWorkSymbolicProblem(unittest.TestCase) :
    def testBoilerplate(self) :
        ...
        self.assertEqual(2, problem.StateVariableDynamics[0].subs(problem.StateVariables[1], 2), msg="eom 1")
        self.assertEqual(3, problem.StateVariableDynamics[1].subs(problem.ControlVariables[0], 3), msg="eom 2")
