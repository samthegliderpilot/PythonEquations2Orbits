...
y = sy.Symbol("y")
jh.showEquation(r'\dot{y}=\frac{dy}{dt}',sy.Function("A")(y)*sy.Symbol("P", commutative=False, algebraic =False)+sy.Symbol("b", commutative=False, algebraic =False), cleanEqu=False)
